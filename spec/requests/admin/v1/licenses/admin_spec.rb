...
RSpec.describe "Admin::V1::Licenses", type: :request do
  ...
  context "POST /game/:game_id/licenses" do
    ...
    context "with invalid params" do
      let(:license_invalid) do
        { license: attributes_for(:license, key: nil) }.to_json
      end

      it "does not a new license" do
        expect do
          post url, headers: auth_header(user), params: license_invalid
